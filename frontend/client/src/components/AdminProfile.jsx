        ...
        <div className='font-serif'>
            ...
            <div className="bg-gray-100">
                <nav className="fixed top-0 left-0 w-full shadow-md transition-all duration-500  bg-blue-500 p-4">
                        <div className="max-w-6xl mx-auto flex items-center justify-start">
                            ...
                            <Link to = '/tracker' className="hover:text-gray-200 cursor-pointer">Manage Users</Link>
                            <Link to = '/shipment' className="hover:text-gray-200 cursor-pointer">Shipment Stats</Link>
            ...
            <div className='flex flex-col lg:flex-row gap-10 pt-32 px-10'>
                ...
                <div className="flex items-center gap-10">
                    <h1 className="text-6xl lg:text-6xl font-bold">Welcome {Profile?.FirstName} !</h1>
